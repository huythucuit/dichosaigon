                ...
                <div id="Extension1">
                  <div class="header">
                    <table>
                      <tbody>
                        <tr>
                          <td style="padding-left:0;width:100%"><button class="button" onclick="window.location='createpost'">Add Record</button></td>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-hover">
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="{{route('editpost', $product->Id)}}" class="btn btn-primary">Sửa</a>
                        </td>
                        <td>
                          <a href="{{route('deletepost', $product->Id)}}" class="btn btn-primary">Xóa</a>
                        </td>
                      </tr>
                      @endforeach
